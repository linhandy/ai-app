...
const PLANS = [
  ...
  },
  {
    ...
    features: ['150 designs / month', 'Up to 4K Ultra resolution', 'No watermark', 'Commercial use license', '⚡ Batch 8 styles at once', 'Hyper Realism quality boost', 'All 40+ styles & room types', 'Priority rendering'],
    cta: 'Upgrade to Pro',
    ctaHref: null,
  ...
  },
  {
    ...
    features: ['500 designs / month', 'All Pro features, plus:', 'Hyper Realism + photorealistic mode', 'Generate up to 8 rooms in parallel', 'Dedicated fast rendering', 'For power users & design studios'],
