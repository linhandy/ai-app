...
export const ROOM_TYPES: RoomType[] = [
  ...
  // 特色空间
  {
    key: 'game_room', label: '游戏室', labelEn: 'Game Room', icon: '🎮',
    promptHint: 'game room with gaming setup and entertainment area',
    promptHintCn: '游戏室，配有游戏设备和娱乐区域',
    seoDescription: 'Game rooms and entertainment spaces let you design a dedicated zone for gaming, media, or recreation. AI Room Designer visualizes setups from pro-grade gaming dens with LED lighting and monitor walls to family-friendly multi-use entertainment rooms.',
  },
  {
    key: 'spa_bathroom', label: 'SPA浴室', labelEn: 'Spa Bathroom', icon: '🧖',
    promptHint: 'spa-style bathroom with soaking tub and wellness area',
    promptHintCn: 'SPA浴室，配有浸泡浴缸和养生空间',
    seoDescription: 'A spa bathroom transforms daily routines into moments of genuine relaxation. AI Room Designer helps visualize luxurious bathroom concepts featuring freestanding soaking tubs, rainfall showers, heated floors, and serene material palettes.',
  },
  {
    key: 'attic', label: '阁楼', labelEn: 'Attic', icon: '🏠',
    promptHint: 'attic room with sloped ceiling and cozy living space',
    promptHintCn: '阁楼，有斜面屋顶的温馨生活空间',
    seoDescription: 'Attic spaces offer some of the most characterful rooms in any home, with sloped ceilings and unique angles creating an intimate, cozy atmosphere. AI Room Designer helps unlock the potential of attic rooms as bedrooms, offices, or creative studios.',
  },
  {
    key: 'basement', label: '地下室', labelEn: 'Basement', icon: '🪨',
    promptHint: 'finished basement with recreation or living area',
    promptHintCn: '地下室，装修好的休闲或居住空间',
    seoDescription: 'A finished basement dramatically increases usable living area and home value. AI Room Designer helps visualize basement transformation ideas — from cozy family rooms and home theaters to guest suites, home gyms, and bar areas.',
  },
  {
    key: 'sunroom', label: '阳光房', labelEn: 'Sunroom', icon: '☀️',
    promptHint: 'sunroom with large windows and natural light',
    promptHintCn: '阳光房，大面积玻璃窗，采光充足',
    seoDescription: 'Sunrooms and conservatories bring the outside in, creating bright, plant-filled spaces that feel like an indoor garden. AI Room Designer helps you visualize four-season rooms, screened porches, and glass-walled additions that blur the boundary between interior and exterior.',
  },
  {
    key: 'mudroom', label: '泥间', labelEn: 'Mudroom', icon: '🧣',
    promptHint: 'mudroom entryway with storage hooks and bench',
    promptHintCn: '泥间，配有挂钩和换鞋凳的储物入口',
    seoDescription: 'A well-designed mudroom keeps the rest of your home clean and organized by providing a dedicated drop zone for coats, shoes, bags, and outdoor gear. AI Room Designer helps you plan functional and stylish entryway storage solutions.',
  },
]
